                ...
                <div className='px-4 py-3 space-y-2'>
                    ...
                    <div>
                        ...
                        <div className={activeTab === "orders" ? "block" : "hidden"}>
                            <Orders isDark={isDark} ordersData={ordersData} setSkip={setSkip} />
                        </div>
...
const Orders = ({ isDark, ordersData, setSkip }) => {
        ...
        <div className='nunitoFont space-y-2'>
            ...
            <div className='max-h-[50dvh] overflow-y-auto space-y-2'>
                {ordersData?.orders?.map((order, idx) => (
                    <div className={`flex items-center justify-between border-2 rounded-lg px-2 py-1 ${isDark ? "border-slate-800" : "border-slate-200"}`}>
                                ...
                                {order?.orderItems?.length > 2 && (
                                    <div className={`h-8 w-8 flex justify-center items-center text-sm font-medium px-2 py-0.5 group rounded relative cursor-pointer ${isDark ? "bg-gray-700 text-gray-300" : "bg-gray-200 text-gray-600"}`}>
                                        ...
                                        <div className={`absolute p-1 z-50 left-0 ${idx !== ordersData?.orders?.length - 2 ? "top-full mt-2" : "bottom-full mb-2"} gap-1 rounded-md hidden group-hover:flex animate-fadeIn ${isDark ? "bg-gray-800" : "bg-gray-200"}`}>
                                            <div className={`absolute ${idx !== ordersData?.orders - 2 ? "-top-4" : "-bottom-4 rotate-180"} left-1 ${isDark ? "text-gray-800" : "text-gray-200"}`}>
                ...
                <button
                    ...
                    disabled={ordersData?.orders?.length >= ordersData?.total}
                >
